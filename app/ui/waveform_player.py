...
class WaveformPlayerWidget(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        self._canvas.setToolTip(
            ...
            "• Click/drag to seek\n"
            "• When focused, press Space to Play/Pause\n"
        ...
        # Spacebar shortcut bound strictly to the canvas widget to prevent conflicts when multiple players are on the same page
        self._space_shortcut = QShortcut(QKeySequence(Qt.Key.Key_Space), self._canvas)
        self._space_shortcut.setContext(Qt.ShortcutContext.WidgetShortcut)
        self._space_shortcut.activated.connect(self.on_play_clicked)
