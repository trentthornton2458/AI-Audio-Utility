...
class WaveformCanvas(QWidget):
    ...
    playPauseRequested = Signal()  # Emits when spacebar is pressed
...
class WaveformPlayerWidget(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        self._canvas.setToolTip(
            ...
            "• Click/drag to seek\n"
            "• When focused, press Spacebar to Play/Pause\n"
        ...
        self._canvas.setAccessibleDescription(
            "Displays the visual peaks and RMS values of the audio. "
            "Click/drag, use keyboard arrows to seek, or press Spacebar to toggle playback."
        )
