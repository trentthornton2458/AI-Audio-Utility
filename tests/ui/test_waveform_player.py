...
def test_waveform_canvas_keyboard_seeking_extra(qtbot):
    from PySide6.QtGui import QKeyEvent
    ...
    # Check Key_Space emits playPauseRequested
    ...
    # Check Key_End seeks to duration_ms
    with qtbot.waitSignal(canvas.seekRequested, timeout=1000) as blocker:
        event = QKeyEvent(
