...
def test_waveform_player_space_shortcut(qtbot, tmp_path):
    player = WaveformPlayerWidget(title="Shortcut Player")
    qtbot.addWidget(player)
    ...
    # Let's mock the on_play_clicked to verify Spacebar activates play/pause
    from unittest.mock import patch

    with patch.object(player, "on_play_clicked") as mock_on_play:
        player._space_shortcut.activated.emit()
